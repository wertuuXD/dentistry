...
$pemeriksaan3 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-9-%'";
$pemeriksaan4 = mysqli_query($conn, $pemeriksaan3);
$p_sept= mysqli_num_rows($pemeriksaan4);

$pemeriksaan4 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-8-%'";
$pemeriksaan5 = mysqli_query($conn, $pemeriksaan4);
$p_aug= mysqli_num_rows($pemeriksaan5);

$pemeriksaan5 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-7-%'";
$pemeriksaan6 = mysqli_query($conn, $pemeriksaan5);
$p_july= mysqli_num_rows($pemeriksaan6);

$pemeriksaan6 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-6-%'";
$pemeriksaan7 = mysqli_query($conn, $pemeriksaan6);
$p_june= mysqli_num_rows($pemeriksaan7);

$pemeriksaan7 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-5-%'";
$pemeriksaan8 = mysqli_query($conn, $pemeriksaan7);
$p_may= mysqli_num_rows($pemeriksaan8);

$pemeriksaan8 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-4-%'";
$pemeriksaan9 = mysqli_query($conn, $pemeriksaan8);
$p_apr= mysqli_num_rows($pemeriksaan9);

$pemeriksaan9 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-3-%'";
$pemeriksaan10 = mysqli_query($conn, $pemeriksaan9);
$p_mar= mysqli_num_rows($pemeriksaan10);

$pemeriksaan10 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-2-%'";
$pemeriksaan11 = mysqli_query($conn, $pemeriksaan10);
$p_feb= mysqli_num_rows($pemeriksaan11);

$pemeriksaan11 = "SELECT * FROM `treatment_record` WHERE treatment_type='pemeriksaan' and treatment_date LIKE '%-1-%'";
...
$cabutan3 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-9-%'";
$cabutan4 = mysqli_query($conn, $cabutan3);
$c_sept= mysqli_num_rows($cabutan4);

$cabutan4 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-8-%'";
$cabutan5 = mysqli_query($conn, $cabutan4);
$c_aug= mysqli_num_rows($cabutan5);

$cabutan5 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-7-%'";
$cabutan6 = mysqli_query($conn, $cabutan5);
$c_july= mysqli_num_rows($cabutan6);

$cabutan6 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-6-%'";
$cabutan7 = mysqli_query($conn, $cabutan6);
$c_june= mysqli_num_rows($cabutan7);

$cabutan7 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-5-%'";
$cabutan8 = mysqli_query($conn, $cabutan7);
$c_may= mysqli_num_rows($cabutan8);

$cabutan8 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-4-%'";
$cabutan9 = mysqli_query($conn, $cabutan8);
$c_apr= mysqli_num_rows($cabutan9);

$cabutan9 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-3-%'";
$cabutan10 = mysqli_query($conn, $cabutan9);
$c_mar= mysqli_num_rows($cabutan10);

$cabutan10 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-2-%'";
$cabutan11 = mysqli_query($conn, $cabutan10);
$c_feb= mysqli_num_rows($cabutan11);

$cabutan11 = "SELECT * FROM `treatment_record` WHERE treatment_type='cabutan' and treatment_date LIKE '%-1-%'";
...
$tampalan3 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-9-%'";
$tampalan4 = mysqli_query($conn, $tampalan3);
$t_sept= mysqli_num_rows($tampalan4);

$tampalan4 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-8-%'";
$tampalan5 = mysqli_query($conn, $tampalan4);
$t_aug= mysqli_num_rows($tampalan5);

$tampalan5 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-7-%'";
$tampalan6 = mysqli_query($conn, $tampalan5);
$t_july= mysqli_num_rows($tampalan6);

$tampalan6 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-6-%'";
$tampalan7 = mysqli_query($conn, $tampalan6);
$t_june= mysqli_num_rows($tampalan7);

$tampalan7 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-5-%'";
$tampalan8 = mysqli_query($conn, $tampalan7);
$t_may= mysqli_num_rows($tampalan8);

$tampalan8 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-4-%'";
$tampalan9 = mysqli_query($conn, $tampalan8);
$t_apr= mysqli_num_rows($tampalan9);

$tampalan9 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-3-%'";
$tampalan10 = mysqli_query($conn, $tampalan9);
$t_mar= mysqli_num_rows($tampalan10);

$tampalan10 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-2-%'";
$tampalan11 = mysqli_query($conn, $tampalan10);
$t_feb= mysqli_num_rows($tampalan11);

$tampalan11 = "SELECT * FROM `treatment_record` WHERE treatment_type='tampalan' and treatment_date LIKE '%-1-%'";
...
$penskaleran3 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-9-%'";
$penskaleran4 = mysqli_query($conn, $penskaleran3);
$ps_sept= mysqli_num_rows($penskaleran4);

$penskaleran4 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-8-%'";
$penskaleran5 = mysqli_query($conn, $penskaleran4);
$ps_aug= mysqli_num_rows($penskaleran5);

$penskaleran5 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-7-%'";
$penskaleran6 = mysqli_query($conn, $penskaleran5);
$ps_july= mysqli_num_rows($penskaleran6);

$penskaleran6 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-6-%'";
$penskaleran7 = mysqli_query($conn, $penskaleran6);
$ps_june= mysqli_num_rows($penskaleran7);

$penskaleran7 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-5-%'";
$penskaleran8 = mysqli_query($conn, $penskaleran7);
$ps_may= mysqli_num_rows($penskaleran8);

$penskaleran8 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-4-%'";
$penskaleran9 = mysqli_query($conn, $penskaleran8);
$ps_apr= mysqli_num_rows($penskaleran9);

$penskaleran9 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-3-%'";
$penskaleran10 = mysqli_query($conn, $penskaleran9);
$ps_mar= mysqli_num_rows($penskaleran10);

$penskaleran10 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-2-%'";
$penskaleran11 = mysqli_query($conn, $penskaleran10);
$ps_feb= mysqli_num_rows($penskaleran11);

$penskaleran11 = "SELECT * FROM `treatment_record` WHERE treatment_type='penskaleran' and treatment_date LIKE '%-1-%'";
...
$perubatanmulut3 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-9-%'";
$perubatanmulut4 = mysqli_query($conn, $perubatanmulut3);
$pm_sept= mysqli_num_rows($perubatanmulut4);

$perubatanmulut4 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-8-%'";
$perubatanmulut5 = mysqli_query($conn, $perubatanmulut4);
$pm_aug= mysqli_num_rows($perubatanmulut5);

$perubatanmulut5 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-7-%'";
$perubatanmulut6 = mysqli_query($conn, $perubatanmulut5);
$pm_july= mysqli_num_rows($perubatanmulut6);

$perubatanmulut6 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-6-%'";
$perubatanmulut7 = mysqli_query($conn, $perubatanmulut6);
$pm_june= mysqli_num_rows($perubatanmulut7);

$perubatanmulut7 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-5-%'";
$perubatanmulut8 = mysqli_query($conn, $perubatanmulut7);
$pm_may= mysqli_num_rows($perubatanmulut8);

$perubatanmulut8 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-4-%'";
$perubatanmulut9 = mysqli_query($conn, $perubatanmulut8);
$pm_apr= mysqli_num_rows($perubatanmulut9);

$perubatanmulut9 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-3-%'";
$perubatanmulut10 = mysqli_query($conn, $perubatanmulut9);
$pm_mar= mysqli_num_rows($perubatanmulut10);

$perubatanmulut10 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-2-%'";
$perubatanmulut11 = mysqli_query($conn, $perubatanmulut10);
$pm_feb= mysqli_num_rows($perubatanmulut11);

$perubatanmulut11 = "SELECT * FROM `treatment_record` WHERE treatment_type='perubatanmulut' and treatment_date LIKE '%-1-%'";
...
$ohi3 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-9-%'";
$ohi4 = mysqli_query($conn, $ohi3);
$o_sept= mysqli_num_rows($ohi4);

$ohi4 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-8-%'";
$ohi5 = mysqli_query($conn, $ohi4);
$o_aug= mysqli_num_rows($ohi5);

$ohi5 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-7-%'";
$ohi6 = mysqli_query($conn, $ohi5);
$o_july= mysqli_num_rows($ohi6);

$ohi6 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-6-%'";
$ohi7 = mysqli_query($conn, $ohi6);
$o_june= mysqli_num_rows($ohi7);

$ohi7 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-5-%'";
$ohi8 = mysqli_query($conn, $ohi7);
$o_may= mysqli_num_rows($ohi8);

$ohi8 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-4-%'";
$ohi9 = mysqli_query($conn, $ohi8);
$o_apr= mysqli_num_rows($ohi9);

$ohi9 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-3-%'";
$ohi10 = mysqli_query($conn, $ohi9);
$o_mar= mysqli_num_rows($ohi10);

$ohi10 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-2-%'";
$ohi11 = mysqli_query($conn, $ohi10);
$o_feb= mysqli_num_rows($ohi11);

$ohi11 = "SELECT * FROM `treatment_record` WHERE treatment_type='ohi' and treatment_date LIKE '%-1-%'";
...
$others3 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-9-%'";
$others4 = mysqli_query($conn, $others3);
$l_sept= mysqli_num_rows($others4);

$others4 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-8-%'";
$others5 = mysqli_query($conn, $others4);
$l_aug= mysqli_num_rows($others5);

$others5 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-7-%'";
$others6 = mysqli_query($conn, $others5);
$l_july= mysqli_num_rows($others6);

$others6 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-6-%'";
$others7 = mysqli_query($conn, $others6);
$l_june= mysqli_num_rows($others7);

$others7 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-5-%'";
$others8 = mysqli_query($conn, $others7);
$l_may= mysqli_num_rows($others8);

$others8 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-4-%'";
$others9 = mysqli_query($conn, $others8);
$l_apr= mysqli_num_rows($others9);

$others9 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-3-%'";
$others10 = mysqli_query($conn, $others9);
$l_mar= mysqli_num_rows($others10);

$others10 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-2-%'";
$others11 = mysqli_query($conn, $others10);
$l_feb= mysqli_num_rows($others11);

$others11 = "SELECT * FROM `treatment_record` WHERE treatment_type='others' and treatment_date LIKE '%-1-%'";
